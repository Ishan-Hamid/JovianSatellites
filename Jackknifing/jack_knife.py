...
JupXI = pd.read_excel(r'File Name', sheet_name='IoData', usecols='A', dtype=float).to_numpy().flatten()
JupYI = pd.read_excel(r'File Name', sheet_name='IoData', usecols='B', dtype=float).to_numpy().flatten()
IoX = pd.read_excel(r'File Name', sheet_name='IoData', usecols='C', dtype=float).to_numpy().flatten()
IoY = pd.read_excel(r'File Name', sheet_name='IoData', usecols='D', dtype=float).to_numpy().flatten()
thetaI = pd.read_excel(r'File Name', sheet_name='IoData', usecols='E', dtype=float).to_numpy().flatten()
scaleI = pd.read_excel(r'File Name', sheet_name='IoData', usecols='F', dtype=float).to_numpy().flatten()
flipI = pd.read_excel(r'File Name', sheet_name='IoData', usecols='G', dtype=bool).to_numpy().flatten()
JupErrXI = pd.read_excel(r'File Name', sheet_name='IoData', usecols='H', dtype=float).to_numpy().flatten()
JupErrYI = pd.read_excel(r'File Name', sheet_name='IoData', usecols='I', dtype=float).to_numpy().flatten()
Time_minsI = pd.read_excel(r'File Name', sheet_name='IoData', usecols='N', dtype=float).to_numpy().flatten()

JupXE = pd.read_excel(r'File Name', sheet_name='EuroData', usecols='A', dtype=float).to_numpy().flatten()
JupYE = pd.read_excel(r'File Name', sheet_name='EuroData', usecols='B', dtype=float).to_numpy().flatten()
EuroX = pd.read_excel(r'File Name', sheet_name='EuroData', usecols='C', dtype=float).to_numpy().flatten()
EuroY = pd.read_excel(r'File Name', sheet_name='EuroData', usecols='D', dtype=float).to_numpy().flatten()
thetaE = pd.read_excel(r'File Name', sheet_name='EuroData', usecols='E', dtype=float).to_numpy().flatten()
scaleE = pd.read_excel(r'File Name', sheet_name='EuroData', usecols='F', dtype=float).to_numpy().flatten()
flipE = pd.read_excel(r'File Name', sheet_name='EuroData', usecols='G', dtype=bool).to_numpy().flatten()
JupErrXE = pd.read_excel(r'File Name', sheet_name='EuroData', usecols='H', dtype=float).to_numpy().flatten()
JupErrYE = pd.read_excel(r'File Name', sheet_name='EuroData', usecols='I', dtype=float).to_numpy().flatten()
Time_minsE = pd.read_excel(r'File Name', sheet_name='EuroData', usecols='N', dtype=float).to_numpy().flatten()

JupXG = pd.read_excel(r'File Name', sheet_name='GanyData', usecols='A', dtype=float).to_numpy().flatten()
JupYG = pd.read_excel(r'File Name', sheet_name='GanyData', usecols='B', dtype=float).to_numpy().flatten()
GanyX = pd.read_excel(r'File Name', sheet_name='GanyData', usecols='C', dtype=float).to_numpy().flatten()
GanyY = pd.read_excel(r'File Name', sheet_name='GanyData', usecols='D', dtype=float).to_numpy().flatten()
thetaG = pd.read_excel(r'File Name', sheet_name='GanyData', usecols='E', dtype=float).to_numpy().flatten()
scaleG = pd.read_excel(r'File Name', sheet_name='GanyData', usecols='F', dtype=float).to_numpy().flatten()
flipG = pd.read_excel(r'File Name', sheet_name='GanyData', usecols='G', dtype=bool).to_numpy().flatten()
JupErrXG = pd.read_excel(r'File Name', sheet_name='GanyData', usecols='H', dtype=float).to_numpy().flatten()
JupErrYG = pd.read_excel(r'File Name', sheet_name='GanyData', usecols='I', dtype=float).to_numpy().flatten()
Time_minsG = pd.read_excel(r'File Name', sheet_name='GanyData', usecols='N', dtype=float).to_numpy().flatten()

JupXC = pd.read_excel(r'File Name', sheet_name='CalliData', usecols='A', dtype=float).to_numpy().flatten()
JupYC = pd.read_excel(r'File Name', sheet_name='CalliData', usecols='B', dtype=float).to_numpy().flatten()
CalliX = pd.read_excel(r'File Name', sheet_name='CalliData', usecols='C', dtype=float).to_numpy().flatten()
CalliY = pd.read_excel(r'File Name', sheet_name='CalliData', usecols='D', dtype=float).to_numpy().flatten()
thetaC = pd.read_excel(r'File Name', sheet_name='CalliData', usecols='E', dtype=float).to_numpy().flatten()
scaleC = pd.read_excel(r'File Name', sheet_name='CalliData', usecols='F', dtype=float).to_numpy().flatten()
flipC = pd.read_excel(r'File Name', sheet_name='CalliData', usecols='G', dtype=bool).to_numpy().flatten()
JupErrXC = pd.read_excel(r'File Name', sheet_name='CalliData', usecols='H', dtype=float).to_numpy().flatten()
JupErrYC = pd.read_excel(r'File Name', sheet_name='CalliData', usecols='I', dtype=float).to_numpy().flatten()
Time_minsC = pd.read_excel(r'File Name', sheet_name='CalliData', usecols='N', dtype=float).to_numpy().flatten()
...
ef
ellipse_eq(x, y, x0, y0, a, b, theta):
